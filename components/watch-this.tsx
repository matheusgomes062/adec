...
export default function WatchThis() {
  return (
    <>
      <a
        className="flex w-96 items-center cursor-pointer group hover:text-blue-100 ease-in-out duration-300"
        target="_blank"
      ...
      >
        ...
        <div className="flex flex-col text-left">
          <h6
            className={`${inter.className} uppercase font-bold text-sm mb-2 text-white`}
          >
            Assista a palavra mais recente
          </h6>
          <h3 className={`${pt_Serif.className} text-white`}>
